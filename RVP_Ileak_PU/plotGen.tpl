...
%load data%
load RVP_Ileak_PU/DAT/dc_dc.dat;
load RVP_Ileak_PU/DAT/dc_P1_PX_d.dat;
...
fout = fopen('RVP_Ileak_PU/data.txt', 'w');
fprintf(fout, '%e\n', abs(I(1,1)));
fclose(fout);
...
%save and close%
print(gcf, '-depsc', 'RVP_Ileak_PU/IMG/RVP_Ileak_PU.eps');
close(gcf);
