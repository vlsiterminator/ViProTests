...
%load data%
load RVP_Ileak_PD/DAT/dc_dc.dat;
load RVP_Ileak_PD/DAT/dc_N1_NX_d.dat;
...
%fout = fopen('RVP_Ileak_PD/data.txt','w');
%fprintf(fout, '%e\n',I(1,1));
%fclose(fout);
...
%save and close%
print(gcf, '-depsc', 'RVP_Ileak_PD/IMG/RVP_Ileak_PD.eps');
close(gcf);
